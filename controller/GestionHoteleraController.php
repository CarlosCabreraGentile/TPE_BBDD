...
class GestionHoteleraController extends SecuredController
{
  ...
  public function BuscarHabitaciones(){
    ...
    //     }
    //   }
    $distribuidor=$this->model->getdistribuidor();
    $productos=$distribuidor['id_distribuidor'];
    $marca=$distribuidor['nombre'];
    $this->view->mostrarBuscarHabitaciones($productos, $marcas);
  }
